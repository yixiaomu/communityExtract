package cn.passionshark.project.community.common.http;
...
public class HttpUtil {
    ...
    public static Response sendGetRequest(String url, String charset, Map<String, String> params) throws Exception {
        // 1. Create URI
        URI uri = java.net.URI.create(url);
